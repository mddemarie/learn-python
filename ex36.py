...
def have_key():
	...
	print("3. Open the door in front.")
	next = input("> ")
...
def first_option():
	...
	while True:
		if prev_room == "Open door on the left" or "open the door" or "open the left door" or "open the door 1" or "unlock" or "unlock door" and true_door:
			prev_room()
			door_bear()
		elif 
		else:
...
def game_over():
	print("This is not possible! Game over!")
	exit(0)
